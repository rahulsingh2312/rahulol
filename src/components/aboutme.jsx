...
function AboutMe() {
  ...
  return (
    <div onClick={handleClick} className='h-screen -mt-12   text-black-100' style={{ backgroundColor: "#F4EAE1" ,filter: 'blur(1px)' }}>
     ...
     <div className=''>
      <div className='w-1/5 h-1/5 md:w-1/6 md:h-1/6' style={{ position: 'absolute',zIndex: 0, top: '0', left:'70%', background: `linear-gradient(90deg, ${gradientColors[0][0]} 100%, ${gradientColors[0][1]} 100%)`, borderRadius: 400, boxShadow: '400px 400px 400px ', filter: 'blur(70px)', animation: 'slideRight 4s linear infinite' }} />
      <div className='w-1/5 h-1/5 md:w-1/6 md:h-1/6' style={{ position: 'absolute', zIndex: 0,bottom: '50%', left:'20%', background: `linear-gradient(90deg, ${gradientColors[1][0]} 100%, ${gradientColors[1][1]} 100%)`, borderRadius: 400, boxShadow: '400px 400px 400px ', filter: 'blur(70px)', animation: 'slideLeft 3s linear infinite' }} />
      <div className='w-1/5 h-1/5 md:w-1/6 md:h-1/6' style={{ position: 'absolute', zIndex: 0,right: '50%' , bottom:'10%', background: `linear-gradient(90deg, ${gradientColors[0][0]} 100%, ${gradientColors[0][1]} 100%)`, borderRadius: 400, boxShadow: '400px 400px 400px ', filter: 'blur(70px)', animation: 'slideRight 4s linear infinite' }} />
      <div className='w-1/5 h-1/5 md:w-1/6 md:h-1/6' style={{ position: 'absolute', zIndex: 0,left: '0%' , top:'50%', background: `linear-gradient(90deg, ${gradientColors[1][0]} 100%, ${gradientColors[2][1]} 100%)`, borderRadius: 400, boxShadow: '400px 400px 400px ', filter: 'blur(70px)', animation: 'slideLeft 3s linear infinite' }} />
      <div className='w-1/5 h-1/5 md:w-1/6 md:h-1/6' style={{ position: 'absolute', right: '40%',top:'40%',zIndex: 0, background: `linear-gradient(90deg, ${gradientColors[2][0]} 100%, ${gradientColors[0][1]} 100%)`, borderRadius: 400, boxShadow: '400px 400px 400px ', filter: 'blur(70px)', animation: 'slideRight 4s linear infinite' }} />
      <div className='w-1/5 h-1/5 md:w-1/6 md:h-1/6' style={{ position: 'absolute', left: '30%',zIndex: 0, background: `linear-gradient(90deg, ${gradientColors[2][0]} 100%, ${gradientColors[0][0]} 100%)`, borderRadius: 400, boxShadow: '400px 400px 400px ', filter: 'blur(70px)', animation: 'slideLeft 3s linear infinite' }} />
