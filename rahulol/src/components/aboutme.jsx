...
function AboutMe() {
  ...
  return (
    <div onClick={handleClick} className='h-screen -mt-12   text-black-100' style={{ backgroundColor: "#F4EAE1" }}>
     ...
     <div className=''>
      <div style={{ width: '20%', height: '20%', position: 'absolute',zIndex: 0, top: '0', left:'50%', background: `linear-gradient(90deg, ${gradientColors[0][0]} 100%, ${gradientColors[0][1]} 100%)`, borderRadius: 400, filter: 'blur(40px)', animation: 'slideRight 4s linear infinite' }} />
      <div style={{ width: '20%', height: '20%', position: 'absolute', zIndex: 0,bottom: '50%', background: `linear-gradient(90deg, ${gradientColors[1][0]} 100%, ${gradientColors[1][1]} 100%)`, borderRadius: 400, filter: 'blur(40px)', animation: 'slideLeft 3s linear infinite' }} />
      <div style={{ width: '20%', height: '20%', position: 'absolute', zIndex: 0,right: '30%' , bottom:'10%', background: `linear-gradient(90deg, ${gradientColors[0][0]} 100%, ${gradientColors[0][1]} 100%)`, borderRadius: 400, filter: 'blur(40px)', animation: 'slideRight 4s linear infinite' }} />
      <div style={{ width: '20%', height: '20%', position: 'absolute', zIndex: 0,left: '50%' , top:'40%', background: `linear-gradient(90deg, ${gradientColors[1][0]} 100%, ${gradientColors[2][1]} 100%)`, borderRadius: 400, filter: 'blur(40px)', animation: 'slideLeft 3s linear infinite' }} />
      <div style={{ width: '20%', height: '20%', position: 'absolute', right: '0',zIndex: 0, background: `linear-gradient(90deg, ${gradientColors[2][0]} 100%, ${gradientColors[0][1]} 100%)`, borderRadius: 400, filter: 'blur(40px)', animation: 'slideRight 4s linear infinite' }} />
      <div style={{ width: '20%', height: '20%', position: 'absolute', left: '30%',zIndex: 0, background: `linear-gradient(90deg, ${gradientColors[2][0]} 100%, ${gradientColors[0][0]} 100%)`, borderRadius: 400, filter: 'blur(40px)', animation: 'slideLeft 3s linear infinite' }} />
      
      </div>
      <div className='flex justify-center pt-28 md:pt-40'  style={{ zIndex: 10, color: 'rgba(105, 111, 77, 0.80)', fontSize: 50, fontFamily: 'Inknut Antiqua', fontWeight: '100', lineHeight: 1.3, wordWrap: 'break-word' }}>RAHUL <br />SINGH<br />DEVELOPER<br />DREAMER<br />DELUSION<br /></div>
