  ...
  return (
    <div onClick={handleClick} className='h-screen -mt-12   text-black-100' style={{ backgroundColor: "#F4EAE1" }}>
     ...
     <div className=''>
      ...
      <div className='w-1/5 h-1/5 md:w-1/6 md:h-1/6' style={{ position: 'absolute', zIndex: 0,left: '50%' , top:'40%', background: `linear-gradient(90deg, ${gradientColors[1][0]} 100%, ${gradientColors[2][1]} 100%)`, borderRadius: 400, filter: 'blur(40px)', animation: 'slideLeft 3s linear infinite' }} />
      <div className='w-1/5 h-1/5 md:w-1/6 md:h-1/6' style={{ position: 'absolute', right: '0',zIndex: 0, background: `linear-gradient(90deg, ${gradientColors[2][0]} 100%, ${gradientColors[0][1]} 100%)`, borderRadius: 400, filter: 'blur(40px)', animation: 'slideRight 4s linear infinite' }} />
