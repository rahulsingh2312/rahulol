...
return (
    ...
    <div className='text-white  z-1 text-sm helvetica bg-black md:hidden ml-10 z-50 text-4xl absolute '> 
       Hiiii I'm A Tech Enthusiast and a learner 🧑‍💻, i usually talk in methaphors and javascript,who is really optimistic and overconfident (ya i use that as a strength idk) , I'm Nocturnal🦉 and a bit delusional and sometimes I'm a Social Animal And a developer .
       </div>
    </div>
);
